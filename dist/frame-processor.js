...
exports.FrameProcessor = exports.defaultV5FrameProcessorOptions = exports.defaultLegacyFrameProcessorOptions = void 0;
    ...
    constructor(modelProcessFunc, modelResetFunc, options) {
        ...
        this.process = async (frame) => {
            ...
            if (probs.isSpeech >= this.options.positiveSpeechThreshold &&
                ...
                return { probs, msg: messages_1.Message.SpeechStart, audio, frame };
            }
